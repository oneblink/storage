...
- `title` is now encoded in `OneBlinkUploader.uploadFormSubmissionDraft()`
...
- `previousElapsedDurationSeconds` to `OneBlinkUploader.uploadFormSubmissionDraft()`

## [3.3.0] - 2025-12-04

### Added

- `OneBlinkUploader.uploadAiBuilderAttachment()`

## [3.2.3] - 2025-08-29

### Added

- `attachmentsAccessToken` to `OneBlinkUploader.uploadSubmission()` return type
